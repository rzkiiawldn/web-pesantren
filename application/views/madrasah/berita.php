    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end">
            <div class="col-md-9 ftco-animate pb-5">
                <p class="breadcrumbs mb-2"><span class="mr-2"><a href="<?= base_url('madrasah/beranda') ?>">Beranda <i class="fa fa-chevron-right"></i></a></span> <span><?= $title; ?> <i class="fa fa-chevron-right"></i></span></p>
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        ...
                        <div class="text mt-3">
                            ...
                            <p><a href="<?= base_url('madrasah/berita/lihat_berita/' . $b['id_berita']); ?>" class="btn btn-primary">Selengkapnya</a></p>
                        </div>
                    </div>
                </div>
            <?php } ?>
