            ...
            <?php foreach ($fasilitas as $f) { ?>
                <div class="col-md-4 ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        ...
                        <div class="text mt-3">
                            <h3 class="heading text-capitalize"><a href="<?= base_url('madrasah/sarana_prasarana/detail/' . $f['id_fasilitas']); ?>"><?= $f['nama_fasilitas']; ?></a></h3>
                            <p><?= nl2br(word_limiter($f['keterangan'], 6)); ?>. </p>
                            <p><a href="<?= base_url('madrasah/sarana_prasarana/detail/' . $f['id_fasilitas']); ?>" class="btn btn-primary">Selengkapnya</a></p>
                        </div>
                    </div>
                </div>
            <?php } ?>
