            ...
            <?php foreach ($eskul as $e) { ?>
                <div class="col-md-4 ftco-animate">
                    <div class="blog-entry align-self-stretch">
                        <a class="block-20 rounded" style="background-image: url('../assets/admin/img/eskul/<?= $e['foto'] ?>');">
                        </a>
                        <div class="text mt-3">
                            <h3 class="heading text-capitalize"><a href="<?= base_url('madrasah/ekstrakurikuler/detail/' . $e['id_eskul']); ?>"><?= $e['nama_eskul']; ?></a></h3>
                            <p><?= nl2br(word_limiter($e['keterangan'], 6)); ?>.</p>
                            <p><a href="<?= base_url('madrasah/ekstrakurikuler/detail/' . $e['id_eskul']); ?>" class="btn btn-primary">Selengkapnya</a></p>
                        </div>
                    </div>
                </div>
            <?php } ?>
